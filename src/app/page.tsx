        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              <Link
                href="/shop"
                className="inline-block bg-[#7A8B75] text-white font-medium px-8 py-4 rounded-lg hover:bg-[#6a7a65] motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C29E5F] text-base"
              >
                Shop the collection
              </Link>
              <Link
                href="/about"
                className="inline-block text-[#C29E5F] font-medium px-2 py-4 underline underline-offset-4 hover:text-[#a8874f] motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C29E5F] rounded text-base"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((product) => (
              <article
                key={product.id}
                className={`bg-[#FAFAF7] rounded-xl overflow-hidden border motion-safe:transition-shadow hover:shadow-md ${
                  product.isFeatured
